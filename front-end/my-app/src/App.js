...
function App() {
  ...
  const filterCharacters = (character) => {
    ...
    const alignmentMatch =
      !filterAlignment || filterAlignment === character.biography.alignment;
    const publisherMatch =
      !filterPublisher || filterPublisher === character.biography.publisher;
    const favoritesMatch =
      !filterFavorites || favoriteTeam.find((c) => c._id === character._id);
